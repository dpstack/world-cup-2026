  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ flex: 1, overflowY: 'auto', display: 'flex', flexDirection: 'column', gap: 8, paddingBottom: 20, textAlign: 'left' }}>
          {filtered.length === 0 ? (
            <div role="status" style={{ textAlign: 'center', padding: '40px 20px', color: '#888', fontFamily: font }}>
